<?php 
  ...
  $dor = mysqli_query($koneksi, "SELECT * FROM riwayat WHERE id_user ='$auth' AND riwayat='Penarikan' ");
...
<body>
   ...
   <center>
    <h1 class="header_pemasukkan">PENARIKAN</h1>
   </center>
      ...
      <div class="container fw-bold" style="  max-width: 1800px;">
        <?php foreach ($dor as $key ): ?>
          <div class="row mt-2">
            ...
            <div class="col-3" style="  margin-left: 90px;">Rp <?php echo number_format($key["aksi"], 0, ".", "."); ?>
            </div>
