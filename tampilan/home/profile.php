 ...
 <body id="body2">
    ...
    <?php if (isset($_SESSION['berhasil'])): ?>
        <div class="alert alert-success alert-dismissible fade show" role="alert">
          <strong>Profile berhasil diganti</strong>
            ...
            <div class="col-3 border-end border-dark">
                <center>
                   <?php if ($row["gambar"] == null){ ?>
                    ...
                    <a href="updateprofile.php" class="btn btn-dark mt-4  ">Update Profile</a><br>
                    <a href="../login/ubahpw.php" class="btn btn-dark mt-2  ">Ubah PW</a>
                </center>
            </div>
            <div class="col-8 pt-5 pb-5 text-dark " style="margin-left: 50px">
                <div class="row">
