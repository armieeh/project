    ...
    <?php  include "../navbar/nav.php"; ?>
     ...
     <div class="container">
     	<div class="row mb-4">
          ...
          <a href="../home/pemasukan.php" style="text-decoration: none; color: black;">
     			    <p class="row pengeluaran-pemasukan"><b>Pengisisan</b></p>
              <?php 
        ...
        <div class="col-5 btn btn-outline-dark">
          <a href="../home/pengeluaran.php" style="text-decoration: none; color: black;">
              <p class="pengeluaran-pemasukan"><b>Penarikan</b></p>
               <?php 
